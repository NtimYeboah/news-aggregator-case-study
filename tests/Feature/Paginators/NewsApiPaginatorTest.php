...
use App\Models\News;
use App\News\Paginators\NewsApi;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class NewsApiPaginatorTest extends TestCase
{
    use RefreshDatabase;

    public function test_can_get_newsapi_articles_page_total(): void
    {
        $responseMock = [
            'status' => 'ok',
            'totalResults' => 638,
        ...
        $pageTotal = (new NewsApi($responseMock))->getPageTotal();

        $this->assertEquals(7, $pageTotal);
    }
}
