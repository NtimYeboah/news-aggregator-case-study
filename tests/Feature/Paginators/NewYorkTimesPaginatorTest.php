...
use App\Models\News;
use App\News\Paginators\NewYorkTimes;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class NewYorkTimesPaginatorTest extends TestCase
{
    use RefreshDatabase;

    public function test_can_get_new_york_times_articles_page_total(): void
    {
        $responseMock = [
            'status' => 'OK',
        ...
        $pageTotal = (new NewYorkTimes($responseMock))->getPageTotal();

        $this->assertEquals(119, $pageTotal);
    }
}
